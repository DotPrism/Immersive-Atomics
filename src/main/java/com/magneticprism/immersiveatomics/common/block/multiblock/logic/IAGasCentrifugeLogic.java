...
public class IAGasCentrifugeLogic implements IMultiblockLogic<IAGasCentrifugeLogic.State>, IServerTickableComponent<IAGasCentrifugeLogic.State>, IClientTickableComponent<IAGasCentrifugeLogic.State>, MBOverlayText<IAGasCentrifugeLogic.State>
{
    ...
    @Override
    public void tickClient(IMultiblockContext<IAGasCentrifugeLogic.State> ctx)
    {

    }

    @Override
    public void tickServer(IMultiblockContext<IAGasCentrifugeLogic.State> ctx) {
        final IAGasCentrifugeLogic.State state = ctx.getState();
    ...
    @Override
    public IAGasCentrifugeLogic.State createInitialState(IInitialMultiblockContext<IAGasCentrifugeLogic.State> context)
    {
        return new IAGasCentrifugeLogic.State(context);
    }
    ...
    @Override
    public <T>
    LazyOptional<T> getCapability(IMultiblockContext<IAGasCentrifugeLogic.State> ctx, CapabilityPosition position, Capability<T> cap)
    {
    ...
    @Nullable
    @Override
    public List<Component> getOverlayText(IAGasCentrifugeLogic.State state, Player player, boolean b) {
        return List.of();
    }
...
//    }
    ...
    public static class State implements IMultiblockState
    {
        ...
        public State(IInitialMultiblockContext<IAGasCentrifugeLogic.State> ctx)
        {
