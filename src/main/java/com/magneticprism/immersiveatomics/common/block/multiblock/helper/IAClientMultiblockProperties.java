package com.magneticprism.immersiveatomics.common.block.multiblock.helper;
...
public class IAClientMultiblockProperties implements ClientMultiblocks.MultiblockManualData {
    private final IATemplateMultiblock multiblock;
    @Nullable
    private NonNullList<ItemStack> materials;
    private final ItemStack renderStack;
    @Nullable private final Vec3 renderOffset;

    public IAClientMultiblockProperties(IATemplateMultiblock multiblock, double offX, double offY, double offZ) { this(multiblock, new Vec3(offX, offY, offZ)); }

    private IAClientMultiblockProperties(IATemplateMultiblock multiblock, @Nullable Vec3 renderOffset) {
