...
package com.magneticprism.immersiveatomics.common.blocks;
...
public class BlockIABase<E extends Enum<E> & BlockIABase.IBlockEnum> extends Block implements IIEMetaBlock
{
	...
	public BlockIABase(String name, Material material, PropertyEnum<E> mainProperty, Class<? extends ItemBlockIABase> itemBlock, Object... additionalProperties)
	{
		...
		this.adjustSound();
		//ImmersiveAtomics.registerBlockByFullName(this, itemBlock, registryName);
		IAContent.registeredIABlocks.add(this);
		try
		{
			IAContent.registeredIAItems.add(itemBlock.getConstructor(Block.class).newInstance(this));
		} catch (Exception e)
		{
			e.printStackTrace();
		}
	...
	public BlockIABase setMetaHidden(int... meta)
	{
		for (int i : meta)
		{
	...
	public BlockIABase setHasFlavour(int... meta)
	{
	...
	public BlockIABase<E> setBlockLayer(BlockRenderLayer... layer)
	{
		this.renderLayers = Sets.newHashSet(layer);
		return this;
	}

	public BlockIABase<E> setMetaBlockLayer(int meta, BlockRenderLayer... layer)
	{
	...
	public BlockIABase<E> setMetaLightOpacity(int meta, int opacity)
	{
	...
	public BlockIABase<E> setMetaExplosionResistance(int meta, int resistance)
	{
	...
	public BlockIABase<E> setNotNormalBlock(int meta)
	{
	...
	public BlockIABase<E> setAllNotNormalBlock()
	{
		if (metaNotNormalBlock == null)
			metaNotNormalBlock = new boolean[this.enumValues.length];
	...
	public BlockIABase<E> setOpaque(boolean isOpaque)
	{
		opaqueCube = isOpaque;
		fullBlock = isOpaque;
		return this;
	...
	{
		return ImmersiveAtomics.MODID + ":" + name;
	}
	...
	public abstract static class IALadderBlock<E extends Enum<E> & IBlockEnum> extends BlockIABase<E>
	{
		public IALadderBlock(String name, Material material, PropertyEnum<E> mainProperty,
		                     Class<? extends ItemBlockIABase> itemBlock, Object... additionalProperties)
		{
