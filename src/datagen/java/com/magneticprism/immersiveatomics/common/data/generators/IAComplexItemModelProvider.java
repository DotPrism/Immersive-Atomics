...
import com.magneticprism.immersiveatomics.common.data.TRSRModelBuilder;
...
public class IAComplexItemModelProvider extends ModelProvider<TRSRModelBuilder>
{
    public IAComplexItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper)
    {
        super(output, IALib.MODID, ITEM_FOLDER, TRSRModelBuilder::new, existingFileHelper);
    }
    ...
    {
        generateMultiblockModel("gas_centrifuge", IAMultiblockProvider.GAS_CENTRIFUGE.block());
    }
